...
export default {
  ...
  data () {
    return {
      answer: '',
      text: {
        question: { en: 'Please locate the official documents on the 3rd floor of Tripitaka Library and get the code by solving the annex A for Puzzle 2 in your toolkit', zh: '請找到位於 3 樓藏經閣的公文，並使用實體道具包中的謎題二、附件 A 解鎖密碼，打開密碼鎖後將密碼輸入對話欄驗證' },
